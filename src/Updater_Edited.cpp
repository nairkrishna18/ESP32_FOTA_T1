...
#define RLY3    14 //KRN141221 // Added Relay pin out to indicate toggling and progress of fota
...
size_t UpdateClass::writeStreamEdited(Stream &data,int &TotalBytes) 
{
    ...
    while(remaining()) 
    {
        ...
        while(!toRead) {
            ...
            digitalWrite(RLY3, !digitalRead(RLY3)); // KRN131221 // To indicate fota in progress
